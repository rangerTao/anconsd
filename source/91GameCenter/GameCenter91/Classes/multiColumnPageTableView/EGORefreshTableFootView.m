...
- (void)setState:(EGOPullRefreshState)aState{
	...
	switch (aState) {
		...
		case EGOOPullRefreshLoading:
			...
			break;
        case EGOOPullRefreshHitTheEnd:
            _arrowImage.hidden = YES;
            _statusLabel.text = @"没有了哦";
            break;
		default:
			break;
	}
...
- (void)setReachedTheEnd:(BOOL)reachedTheEnd{
    ...
    if (_reachedTheEnd){
        [self setState:EGOOPullRefreshHitTheEnd];
    } else {
        [self setState:EGOOPullRefreshNormal];
    }
}
...
- (void)egoRefreshScrollViewDidEndDragging:(UIScrollView *)scrollView {
	...
	if (_state==EGOOPullRefreshPulling && scrollView.contentOffset.y + (scrollView.frame.size.height) > scrollView.contentSize.height + RefreshViewHight && !_loading) {
