 ...
 *******************************************************************************/
package com.andconsd.framework.pull;
...
import com.andconsd.framework.pull.internal.FlipLoadingLayout;
import com.andconsd.framework.pull.internal.LoadingLayout;
import com.andconsd.framework.pull.internal.RotateLoadingLayout;
import com.andconsd.framework.pull.internal.Utils;
import com.andconsd.framework.pull.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	/**
	 * Has a bug,在callback中直接在主线程中做任务，然后调用
	 * onRefreshComplete，会出现奇怪的现象，所以加了这个AsyncTask<br>
	 * <p>
	 * <b>Wangliang</b>
	 */
	@Override
	...
	public void setRefreshing(boolean doScroll) {
		if (!isRefreshing()) {
			Object refreshableView = getRefreshableView();
			if (refreshableView instanceof AbsListView) {
				// Log.i("LongTest", "setRefreshing setSelection(0)");
	...
	/**
	 * @return Either {@link com.andconsd.framework.pull.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link com.andconsd.framework.pull.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	 ...
	 * {@link com.andconsd.framework.pull.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.andconsd.framework.pull.PullToRefreshBase.State#REFRESHING} or {@link com.andconsd.framework.pull.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	 * @param doScroll
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.andconsd.framework.pull.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.andconsd.framework.pull.PullToRefreshBase.State#RESET} state.
	 */
	...
	public static enum Mode {
		 ...
		 * {@link com.andconsd.framework.pull.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction
		 *            - One of {@link com.andconsd.framework.pull.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link com.andconsd.framework.pull.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link com.andconsd.framework.pull.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link com.andconsd.framework.pull.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
