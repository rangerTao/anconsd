...
public class AppEntry extends BaseActivity implements AdViewListener, OnClickListener, IRequestListener{

	public static AppEntry appref;
				...
				if (isChecked) {
					...
					try {
						...
						if (ip != null) {
							...
							String cache_dir = SharePreferenceUtil.getInstance(AppEntry.appref).getString(SharePreferenceUtil.SP_CACHE_DIR);
