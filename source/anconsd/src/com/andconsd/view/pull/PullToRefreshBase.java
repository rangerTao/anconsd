 ...
 *******************************************************************************/
package com.andconsd.view.pull;
...
import com.andconsd.view.pull.internal.FlipLoadingLayout;
import com.andconsd.view.pull.internal.LoadingLayout;
import com.andconsd.view.pull.internal.RotateLoadingLayout;
import com.andconsd.view.pull.internal.Utils;
import com.andconsd.view.pull.internal.ViewCompat;
import com.andconsd.view.pull.PullToRefreshBase.Mode;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	/**
	 * @return Either {@link com.andconsd.view.pull.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link com.andconsd.view.pull.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	 ...
	 * {@link com.andconsd.view.pull.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.andconsd.view.pull.PullToRefreshBase.State#REFRESHING} or {@link com.andconsd.view.pull.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	 * @param doScroll
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.andconsd.view.pull.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link com.andconsd.view.pull.PullToRefreshBase.State#RESET} state.
	 */
	...
	public static enum Mode {
		 ...
		 * {@link com.andconsd.view.pull.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction
		 *            - One of {@link com.andconsd.view.pull.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link com.andconsd.view.pull.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link com.andconsd.view.pull.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link com.andconsd.view.pull.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
