...
public class RoundProgressBar extends View {
	 ...
	 * 中间进度百分比的字符串的颜色
	 */
	private int textColor = Color.parseColor("#bdbdbd");
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		// 获取自定义属性和默认值
		roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, Color.parseColor("#dfe3e6"));
		roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundProgressColor, Color.parseColor("#92baed"));
		// textColor =
