...
import com.ranger.bmaterials.BuildConfig;
...
public class PinnedSectionListView extends ListView {
	...
	void createPinnedShadow(int position) {
		...
		if (handle != 0) {
			pinnedShadow.child = pinnedView.findViewById(handle);
			if(pinnedShadow.child==null){
				pinnedShadow.child = pinnedShadow.view;
			}
		} else {
			pinnedShadow.child = pinnedShadow.view;
		}
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (mPinnedSection != null) {
			...
			View view = mPinnedSection.child;
			...
			drawChild(canvas, mPinnedSection.child, getDrawingTime());
	...
	public void setHandleId(int handle) {
		this.handle = handle;
	}
