 ...
 */
public class SizeLimitActivity extends StatActivity
    ...
    public void onResume() {
        super.onResume();
        //�����Ƿ��Զ�ת��
        //deleted by wangliang
        //Utility.setActivityAutoRotateScreen(this, com.duoku.gamesearch.tools.Constants.isAutoRotateScreen(this));
