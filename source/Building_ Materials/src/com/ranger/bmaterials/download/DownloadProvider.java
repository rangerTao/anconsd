...
public final class DownloadProvider extends ContentProvider {
    ...
    /** AUTHORITY. */
    public static final String AUTHORITY = Constants.PREFIX+".download";
    
    /** ����� permission ��add by caoahitao. */
        ...
        private void createDownloadsTable(SQLiteDatabase db) {
            try {
                ...
                db.execSQL("CREATE TABLE " + DB_TABLE + "("
                        ...
                        + Downloads.Impl.COLUMN_URI + " TEXT UNIQUE, " //add by wangliang
    ...
    public boolean onCreate() {
        ...
        */
        ...
        Log.i("DownloadProvider","DownloadProvider onCreate "+Binder.getCallingPid()+" "+Binder.getCallingUid()+Thread.currentThread().getName());
        return true;
    }
     ...
     * @return the string.
     */
    public String getDownloadIdFromUri(final Uri uri) {
    ...
    public int update(final Uri uri, final ContentValues values,
        ...
        if (Binder.getCallingPid() != Process.myPid()) {
            ...
            isRestart = isRestart || (status != null && status == Downloads.Impl.STATUS_PAUSED_BY_APP);
     ...
     */
    private void notifyContentChanged(final Uri uri, int uriMatch,long... rowId) {
    ...
    public int delete(final Uri uri, final String where,
    	...
    	//
   	 	//
        MyLogger logger = MyLogger.getLogger(this.getClass().getSimpleName());
        logger.d( "deleting data,and start service.");
        return count;
    }
