...
public final class Constants {
    ...
    static{
    	...
    	if(PREFIX == null){
			throw new RuntimeException("You must init the field 'prefix' in class com.duoku.gamesearch.download.config.Config at first!");
		}
    }
    ...
    public static final String ACTION_RETRY = PREFIX+".intent.action.DOWNLOAD_WAKEUP";

    /** 锟斤拷锟斤拷失锟杰猴拷锟斤拷锟斤拷锟斤拷锟截碉拷intent */
    public static final String ACTION_REDOWNLOAD = PREFIX+".intent.action.REDOWNLOAD";

    /** the intent that gets sent when clicking a successful download */
    public static final String ACTION_OPEN = PREFIX+".intent.action.DOWNLOAD_OPEN";

    /** the intent that gets sent when clicking an incomplete/failed download  */
    public static final String ACTION_LIST = PREFIX+".intent.action.DOWNLOAD_LIST";

    /** the intent that gets sent when deleting the notification of a completed download */
    public static final String ACTION_HIDE = PREFIX+".intent.action.DOWNLOAD_HIDE";
    ...
    public static final String DEFAULT_DL_SUBDIR = PREFIX+"/downloads";
    ...
    public static final int MIN_PROGRESS_STEP = 8096;
     ...
     */
    public static /*final*/ int MAX_RETRIES = 3; //5;
    ...
    /** Enable super-verbose logging */
    public static final boolean LOGVV =  false ;// LOCAL_LOGVV && LOGV;
    /** 锟斤拷锟斤拷锟斤拷锟斤拷叱谈锟斤拷锟�1 */
    public static /*final*/ int MAX_THREAD = 2;
    /** 锟斤拷锟截碉拷锟斤拷目锟斤拷应id */
    public static final String DOWNLOAD_ID = PREFIX + ".download_id";
}
