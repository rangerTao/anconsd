...
/*import com.duoku.gamesearch.activity.WifiDownLoadDialogActivity;
import com.ranger.bmaterials.R;
import com.duoku.gamesearch.myapp.AppManager;
import com.duoku.gamesearch.tools.Utility;*/
...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        //����DownloadServiceCallback��ʵ��һЩ��ʼ������
        ...
        // �����������ʱ��ȡ�����е�notification,��ᵼ�¸�����ʾ��notificationҲ��ʧ
    ...
    public void onStart(Intent intent, int startId) {
        ...
        /*if (AppManager.getInstance(getApplicationContext()).hasAppDownloading()
                && Utility.isNetWorkEnabled(getApplicationContext()) 
                && !Utility.isWifiNetWork(getApplicationContext())) {
        	
            if (!com.duoku.gamesearch.tools.Constants.isWifiDownloadIndicated(getApplicationContext())) {
                if (Constants.LOGVV) {
                    Log.d(Constants.TAG, "Non-WiFi download indicating!");
                }

                // ��ʾ��wifi���ص���ʾ
                Intent dialogIntent = new Intent(DownloadService.this, WifiDownLoadDialogActivity.class);
                dialogIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(dialogIntent);
                return;
                
            } else if (com.duoku.gamesearch.tools.Constants.isWifiDownloadEnabled(getApplicationContext())) {
                if (Constants.LOGVV) {
                    Log.d(Constants.TAG, "gprs download and wifiEnable!");
                }

                AppManager.getInstance(getApplicationContext()).pauseAllDownload();
                Toast.makeText(getApplicationContext(), R.string.wifi_download_toast, Toast.LENGTH_LONG).show();
                return;
            }
        }
*/
    ...
    public void onDestroy() {
        ...
        MyLogger logger = MyLogger.getLogger(this.getClass().getSimpleName());
        if (Constants.LOGVV) {
        	logger.v( "Service onDestroy");
        }
        
        try {
        	mMediaScannerConnection.disconnectMediaScanner();
		} catch (Exception e) {
			logger.e("disconnectMediaScanner error",e);
		}
    ...
    private void updateFromProvider() {
        synchronized (this) {
        	MyLogger logger = MyLogger.getLogger(this.getClass().getSimpleName());
        	logger.v( "Service updateFromProvider mUpdateThread = null?"+(!(mUpdateThread != null)));
            mPendingUpdate = true;
    ...
    private class UpdateThread extends Thread {
        ...
        public void run() {
        	MyLogger logger = MyLogger.getLogger(this.getClass().getSimpleName());
        	logger.v( "Service UpdateThread run ");
            ...
            for (;;) {
            	logger.v( "Service running..."+mDownloads.keySet().toString());
                synchronized (DownloadService.this) {
                    ...
                    if (!mPendingUpdate) {
                        ...
                        if (!keepService) {
                            stopSelf();
                            logger.v("Service running...stopSelf");
                        }
                ...
                try {
                    ...
                    logger.i("mDownloads "+mDownloads.keySet() +" coursor count:"+cursor.getCount());
                    ...
                    logger.i("mDownloads(updateDownload/insertDownload)"+mDownloads.keySet());
                } finally {
                    cursor.close();
                }
                logger.i("idsNoLongerInDatabase "+idsNoLongerInDatabase);
                ...
                logger.i( "mustScan:"+mustScan); 
                if (mustScan) {
                	logger.i( "bindMediaScanner"); 
                    bindMediaScanner();
                } else {
                	logger.i("disconnectMediaScanner"); 
                    mMediaScannerConnection.disconnectMediaScanner();
                }
        ...
        private void scheduleAlarm(long wakeUp) {
            ...
            //intent.setClassName("com.duoku.gamesearch",DownloadReceiver.class.getName());
            alarms.set(
