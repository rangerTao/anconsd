...
/*!
 ...
 @result a client ref(bigger than 0) if success, or else an error is returned
 */
- (NDNetHttpTransferIDRef)post_GetData:(NSString*)urlString dataToPost:(NSData*)dataToPost dataToAccept:(NSMutableData*)dataToAccept httpHeader:(NSDictionary *)httpHeader delegate:(id)myDelegate;
...
@result a client ref(bigger than 0) if success, or else an error is returned
*/
- (NDNetHttpTransferIDRef)post_GetData:(NSString*)urlString dataToPost:(NSData*)dataToPost httpHeader:(NSDictionary *)httpHeader delegate:(id)myDelegate;
