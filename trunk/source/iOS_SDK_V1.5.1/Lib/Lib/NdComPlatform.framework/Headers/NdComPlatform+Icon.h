...
#import "NdComPlatformAPIResponse+Icon.h"
...
/**
 ...
 @result 错误码
 */
- (int)NdSetPortrait:(UIImage*)img  delegate:(id)delegate;
...
/**
 NdSetPortrait的回调
 @param error 错误内容，如果error为nil，则代表API执行成功，否则失败。错误码涵义请查看NdComPlatformError文件
 @param checkSum 上传头像成功后，返回的对应的该用户头像的checkSum
 */
- (void)setPortraitDidFinish:(NSError *)error  checkSum:(NSString *)checkSum;
