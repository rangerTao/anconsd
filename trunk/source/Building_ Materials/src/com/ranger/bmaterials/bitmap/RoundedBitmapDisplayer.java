...
public class RoundedBitmapDisplayer implements BitmapDisplayer {
	...
	public RoundedBitmapDisplayer(int cornerRadiusPixels, int marginLeftPixels, int marginTopPixels, int marginRightPixels, int marginBottomPixels) {
		this.cornerRadius = cornerRadiusPixels;
	...
	public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
		...
		if (sameMargin)
			...
			imageAware.setImageDrawable(new RoundedDrawable(bitmap, cornerRadius, marginLeft, marginTop, marginRight, marginBottom));
	}
	...
	public static class RoundedDrawable extends Drawable {
		...
		public RoundedDrawable(Bitmap bitmap, int cornerRadius, int marginLeftPixels, int marginTopPixels, int marginRightPixels, int marginBottomPixels) {
		...
		protected void onBoundsChange(Rect bounds) {
			...
			if (sameMargin)
				...
				mRect.set(marginLeft, marginTop, bounds.width() - marginRight, bounds.height() - marginBottom);
		}
