...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF448BDC;
	private int underlineColor = 0xFFe3e3e3;// 0x1A000000;
	...
	private int tabTextColor = 0xFF6B6B6B;
	private int tabTextColorSelected = 0xFF448BDC;
	...
	private PagerStripOnClickListener clickListener;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		defaultTabLayoutParams = expandedTabLayoutParams;// new
	...
	public void updateTitle(int page, String title) {
		if (page < 0 || page >= tabCount) {
			return;
		}
		View v = tabsContainer.getChildAt(page);
	...
	public void setOnTabClickListener(PagerStripOnClickListener l) {
		// TODO Auto-generated method stub
		clickListener = l;
	}

	public interface PagerStripOnClickListener {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft, height - indicatorHeight, lineRight + 4,
				height, rectPaint);
		...
		canvas.drawRect(0, height - underlineHeight,
				tabsContainer.getWidth() + 4, height, rectPaint);
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrolled(int position, float positionOffset,
			...
			if (Constants.DEBUG)
				Log.i(TAG, "PageListener  onPageScrolled " + position
		...
		public void onPageScrollStateChanged(int state) {
			if (Constants.DEBUG)
				Log.i(TAG, "PageListener  onPageScrollStateChanged state:"
						+ state);
		...
		public void onPageSelected(int position) {
			if (Constants.DEBUG)
				Log.i(TAG, "PageListener  onPageSelected " + position);
			for (int i = 0; i < tabCount; i++) {
				View v = tabsContainer.getChildAt(i);
				if (v instanceof TextView) {
					TextView tab = (TextView) v;
