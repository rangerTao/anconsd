...
public class GameDetailWorkspace extends ViewGroup {
	...
	public GameDetailWorkspace(Context context,AttributeSet attr){
		super(context,attr);
		mContext = context;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if(ev.getAction() == MotionEvent.ACTION_DOWN){
			...
			//Log.i("wwwww", "GameDetailWorkspace intercept move out");
			//Log.i("WWWWW", "gamepicsmoving: "+GameDetailsActivity.gamepicsmoving+".....MyScrollView.ismoving: "+MyScrollView.ismoving);
			if(Math.abs(x - ev.getRawX()) > 30 && Math.abs(y - ev.getRawY()) < 20 && !GameDetailConstants.gamepicsmoving && !MyScrollView.ismoving){
				//Log.i("wwwww", "GameDetailWorkspace intercept move");
				return true;  
			}
		} 
