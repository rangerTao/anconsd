...
/**
 * ����SDK4.0������SDK4.0֪ͨ�Ľӿڲ�ͬ
 * ����notification.builder���ý�ȵ�api����api14���ϲ��У�
 * ����SDK4.0�����������ϵ��ṩ@VersionNotification14��SDK4.0���µ��ṩ@VersionNotification13
 */
public abstract class VersionedNotification {
    /**
     * ��ȡNotification������Բ�ͬ��SDK�����ز�ͬ�Ķ���
     * 
...
//            n.largeIcon = mLargeIcon;
        ...
        private RemoteViews makeRemoteViews(int resId) {
            ...
            /*
             * ���ô��� if (mWhen != 0) { contentView.setLong(R.id.time, "setTime",
             * mWhen); }
             */
            return contentView;
        }
