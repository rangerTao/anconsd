...
public final class Helpers {
    ...
    private static String getPathForFileUri(String hint, long contentLength)
        ...
        if (new File(path).exists()) {
            Log.e(Constants.TAG, "File already exists: " + path);
            //modified by wangliang.
            new File(path).delete();
            //throw new GenerateSaveFileError(Downloads.Impl.STATUS_FILE_ALREADY_EXISTS_ERROR,"requested destination file already exists");
        }
    ...
    private static String chooseFullPath(Context context, String url, String hint,
        ...
        int dotIndex = filename.lastIndexOf('.'); // �ҵ����һ��.
        if (dotIndex < 0) {
