...
public final class Downloads {
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = Constants.PREFIX+".permission.ACCESS_DOWNLOAD_MANAGER";
    ...
    public static final String PERMISSION_ACCESS_ADVANCED =
    		Constants.PREFIX+".permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to directly access the download manager's cache directory
     * @hide
     */
    public static final String PERMISSION_CACHE = Constants.PREFIX+".permission.ACCESS_CACHE_FILESYSTEM";
    ...
    public static final String PERMISSION_SEND_INTENTS =
    		Constants.PREFIX+".permission.SEND_DOWNLOAD_COMPLETED_INTENTS";
    ...
    public static final Uri CONTENT_URI =
        Uri.parse("content://" + DownloadProvider.AUTHORITY + "/my_downloads");
    ...
    public static final String ACTION_DOWNLOAD_COMPLETED =
    		Constants.PREFIX+".intent.action.DOWNLOAD_COMPLETED";
    ...
    public static final class Impl implements BaseColumns {
        ...
        public static final String PERMISSION_ACCESS_ALL =
        		Constants.PREFIX+".permission.ACCESS_ALL_DOWNLOADS";
        ...
        public static final String PERMISSION_CACHE_NON_PURGEABLE =
        		Constants.PREFIX+".permission.DOWNLOAD_CACHE_NON_PURGEABLE";
        ...
        public static final String PERMISSION_NO_NOTIFICATION =
        		Constants.PREFIX+".permission.DOWNLOAD_WITHOUT_NOTIFICATION";
        ...
        public static final Uri ALL_DOWNLOADS_CONTENT_URI =
                Uri.parse("content://" + DownloadProvider.AUTHORITY + "/all_downloads");
         ...
         * data. ע�⣺����ڿ�������ǰ��ָ���������ļ����ͣ��������ع���У������ָ�����Ͳ�һ�£��������ʧ�ܡ�
         * ���ָ���������ͣ��򲻴��?��ʹ��response Header�е�mimetype.
         * <P>
         * Type: TEXT
         * </P>
         * <P>
