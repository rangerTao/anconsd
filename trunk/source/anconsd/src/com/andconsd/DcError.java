...
public final class DcError {
	...
	public static final int DC_FILE_INVALID			= 1023;     //上传的文件不符合规则
	public static final int DC_NO_GAME_NUMBER			= 1024;     //抢号号码被抢光
	public static final int DC_HAVE_SENSITIVE_WORD		= 1025;     //敏感词错误
     ...
     * 库存数量不足
     */
    public static final int DC_OUT_OF_STOCK                 = 1036;
    
    /**
     * 活动过期
     */
    public static final int DC_ACTIVITY_OFFLINE             = 1037;
    
    public static final int DC_NETWORK_NOT_AVAILABLE        = 9999;
}
