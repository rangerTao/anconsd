...
import com.andconsd.barcode.EncodingHandler;
...
import com.andconsd.ui.picview.PicFlowListActivity;
				...
				if (isChecked) {
					...
					try {
						...
						if (!wifiManager.isWifiEnabled()) {
							Toast.makeText(appref, "未连接到WIFI", 2000).show();
						}
						...
						if (ip != null) {
							...
							Toast.makeText(appref, "network error", 2000).show();
						}
